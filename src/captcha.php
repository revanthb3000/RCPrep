...
/*
 * if (!empty($_SERVER['HTTP_ACCEPT_LANGUAGE'])) { $langs = array('en', 'es'); $lang = substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2); if (in_array($lang, $langs)) { $captcha->wordsFile = "words/$lang.php"; } }
 */
...
class SimpleCaptcha {
	...
	protected function ReduceImage() {
        ...
        $imResampled// Reduzco el tamaño de la imagen
